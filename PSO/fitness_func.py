...
class fitness_func():
    ...
    def set_weights(self):
        ...
        # """Region 1"""
        # weights_matrix[0][0]=0.4 #desviacion 31
        # weights_matrix[0][1]=0.01 #desviacion 41
        # weights_matrix[0][2]=0.4 #osc. 31 Estos corresopnden con lambda de la eq de tikhonov
        # weights_matrix[0][3]=0.19 #osc. 41
        
        
        # """Region 2"""
        # weights_matrix[1][0]=0.4
        # weights_matrix[1][1]=0.4
        # weights_matrix[1][2]=0.1 #osc. 31 Estos corresopnden con lambda de la eq de tikhonov
        # weights_matrix[1][3]=0.1
        
        # """Region 3"""
        # weights_matrix[2][0]=0.2
        # weights_matrix[2][1]=0.2
        # weights_matrix[2][2]=0.2 #osc. 31 Estos corresopnden con lambda de la eq de tikhonov
        # weights_matrix[2][3]=0.2

        """Region 1"""
        weights_matrix[0][0]=0.005 #desviacion 31
        weights_matrix[0][1]=0.005 #desviacion 41
        weights_matrix[0][2]=0.001 #osc. 31 Estos corresopnden con lambda de la eq de tikhonov
        weights_matrix[0][3]=0.001 #osc. 41
        weights_matrix[0][4]=0.001 #Amp imbalance

        
        """Region 2"""
        weights_matrix[1][0]=0.470
        ...
        weights_matrix[1][4]=0.032#Amp Imbalance

        """Region 3"""
        weights_matrix[2][0]=0.001
        weights_matrix[2][1]=0.001
        weights_matrix[2][2]=0.001 #osc. 31 Estos corresopnden con lambda de la eq de tikhonov
        weights_matrix[2][3]=0.001
        weights_matrix[2][4]=0.001 #Amp Imbalance
