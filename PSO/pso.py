...
def fitness(results,iter):
    ...
    _=fitnessObj.set_constraints('region_1_S21',true_value=-5.0, min_val=-5.5, max_val=-2.5,type_constraint='in_limit')
    _=fitnessObj.set_constraints('region_1_over_S31',true_value=-2, min_val=-3.5, max_val=-1,type_constraint='overshoot')
    _=fitnessObj.set_constraints('region_1_over_S21',true_value=-3, min_val=-20, max_val=-1,type_constraint='overshoot')
    ...
    _=fitnessObj.set_constraints('region_3_S31',true_value=-3.0, min_val=-3.5, max_val=-2,type_constraint='in_limit')
    _=fitnessObj.set_constraints('region_3_S21',true_value=-3.0, min_val=-5, max_val=-2.5,type_constraint='in_limit')
    _=fitnessObj.set_constraints('region_3_over_S31',true_value=-3, min_val=-3.5, max_val=-1,type_constraint='overshoot')
    _=fitnessObj.set_constraints('region_3_over_S21',true_value=-3, min_val=-20, max_val=-1,type_constraint='overshoot')


    _=fitnessObj.set_constraints('region_1_ampimb',true_value=1, min_val=0.1, max_val=1,type_constraint='in_limit')
    _=fitnessObj.set_constraints('region_2_ampimb',true_value=0.8, min_val=0.1, max_val=0.8,type_constraint='in_limit')
    _=fitnessObj.set_constraints('region_3_ampimb',true_value=1, min_val=0.1, max_val=1,type_constraint='in_limit')
